...
const iconMap = {
  [ChannelType.TEXT]: (
    <Hash className="mr-2 flex-shrink-0 w-5 h-5 text-green-500" />
  ),
  [ChannelType.AUDIO]: (
    <Mic className="mr-2 flex-shrink-0 w-5 h-5 text-indigo-500" />
  ),
  [ChannelType.VIDEO]: (
    <Video className="mr-2 flex-shrink-0 w-5 h-5 text-rose-500" />
  ),
};
